...
export const Route = createLazyFileRoute('/CustomColumnHeight')({
  component: CustomColumnHeight,
})

const columns: readonly ColumnOrColumnGroup<number, number>[] = [
  { key: '1', name: 'Column 1', frozen: true },
  {
    name: 'Group 1',
    children: [
      { key: '2', name: 'Column 2' },
